...
if (Config.WORKTYPE == 'private') {
    ...
    Mybot.addCommand({pattern: 'anime', fromMe: true, desc: 'random anime image'}, (async (message, match) => {
    ...
    Mybot.addCommand({pattern: 'wallpaper', fromMe: true, desc: Lang.WP}, (async (message, match) => {
    ...
    Mybot.addCommand({pattern: 'pink', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe POOCHA SER pazhaya POOCHA SER thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik POOCHA SER n";
...
await message.sendMessage(r_text[i]);
    ...
    Mybot.addCommand({pattern: 'anime', fromMe: false, desc:'random anime image '}, (async (message, match) => {
    ...
    Mybot.addCommand({pattern: 'wallpaper', fromMe: false, desc: Lang.WP}, (async (message, match) => {
    ...
    Mybot.addCommand({pattern: 'pink', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "POOCHA SERne tholpikkaan ningalkavilla. Jeevitathil POOCHA SERne tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "POOCHA SER says i love you 😘";
r_text[3] = "POOCHA SER nte yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "POOCHA SER - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
r_text[7] = "താനാരാണെന്ന് തനിക്ക് അറിയാന്‍ മേലങ്കില്‍താന്‍ എന്നോട്‌ ചോദിക്ക്.. താനാരണെന്ന്...തനിക്ക് ഞാന്‍ പറഞ്ഞു തരാംതാനാരാണെന്ന്...എന്നിട്ട്‌ഞാനാരാണെന്ന് എനിക്കാറിയാമൊന്നുതാനെന്നോട്‌ ചോദിക്ക്..അപ്പോ തനിക്ക് ഞാന്‍ പറഞ്ഞു തരാംതാനാരാണെന്നും ..ഞാനാരാണെന്നും - കുതിരവട്ടം പപ്പു, മണിച്ചിത്രതാഴ് ";
